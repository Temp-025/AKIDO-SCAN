  ...
  function(t, n) {
    !(function(t) {
      var n,
        ...
        o = !1;
      function i(t) {
        n && r && t(n.Start, n.End, r.Start, r.End, n.PageNumber, r.PageNumber);
      }
      function u(t, e, i, u, c) {
        o
          ? ((o = !1),
            (i.textContent = 'Enter Alignment Mode'),
            t.UI.setToolMode('AnnotationEdit'),
            e.UI.setToolMode('AnnotationEdit'),
            t.Core.documentViewer.getAnnotationManager().deleteAnnotations(t.Core.documentViewer.getAnnotationManager().getAnnotationsList(), { imported: !0, force: !0 }),
            e.Core.documentViewer.getAnnotationManager().deleteAnnotations(e.Core.documentViewer.getAnnotationManager().getAnnotationsList(), { imported: !0, force: !0 }),
            (n = void 0),
            (r = void 0),
            c && c())
          : ((o = !0), (i.textContent = 'Leave Alignment Mode'), t.UI.setToolMode('AnnotationCreateArrow'), e.UI.setToolMode('AnnotationCreateArrow'), u && u());
      }
      t.DiffAlignmentTool = {
        initializeDiffAlignmentToolHandlers: function(t, c, f, a, s) {
          ...
          o && u(t, c, l, a, s),
            e ||
              ((e = !0),
              t.Core.documentViewer.getTool('AnnotationCreateArrow').addEventListener('annotationAdded', function(r) {
                n && t.Core.documentViewer.getAnnotationManager().deleteAnnotation(n, { imported: !1, force: !0 }), (r.ReadOnly = !0), (n = r), i(f);
              }),
              c.Core.documentViewer.getTool('AnnotationCreateArrow').addEventListener('annotationAdded', function(t) {
                r && c.Core.documentViewer.getAnnotationManager().deleteAnnotation(r, { imported: !1, force: !0 }), (t.ReadOnly = !0), (r = t), i(f);
              }),
              ...
              document.getElementById('enable-snap-mode').addEventListener('change', function(n) {
                ...
                t.Core.documentViewer.getTool('AnnotationCreateArrow').setSnapMode(r ? t.Core.documentViewer.SnapMode.DEFAULT : null),
                  c.Core.documentViewer.getTool('AnnotationCreateArrow').setSnapMode(r ? c.Core.documentViewer.SnapMode.DEFAULT : null);
              }));
        },
