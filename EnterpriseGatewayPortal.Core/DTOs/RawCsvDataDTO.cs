...
namespace EnterpriseGatewayPortal.Core.DTOs
{
    public class RawCsvDataDTO
    {
        ...
        public string Signature_Validity_Flag { get; set; }
        ...
        public string User_Validity_Flag { get; set; }
        public string User_Valid_From { get; set; }
        public string User_Valid_Upto { get; set; }
    }
