!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), x = r(c, v, 3), b = u(m.length), S = 0, w = e ? h(n, b) : a ? h(n, 0) : void 0; b > S; S++)
  ...
  function(t, n, e) {
    ...
    if (e(8)) {
      var o = e(30),
        ...
        Lt = {
          ...
          subarray: function(t, n) {
            var e = Pt(this),
              r = e.length,
              o = m(t, r);
            return new (I(e, e[mt]))(e.buffer, e.byteOffset + o * e.BYTES_PER_ELEMENT, d((void 0 === n ? r : m(n, r)) - o));
          },
        },
        Rt = function(t, n) {
        ...
        Wt = function(t, n) {
          return Bt(t, (n = x(n, !0))) ? p(2, t[n]) : V(t, n);
        },
        Gt = function(t, n, e) {
      ...
      v(Ut, Ct),
        h(Ut, yt, Ct.values),
        v(Ut, { slice: Rt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: Nt }),
        Mt(Ut, 'buffer', 'b'),
        Mt(Ut, 'byteOffset', 'o'),
        Mt(Ut, 'byteLength', 'l'),
        Mt(Ut, 'length', 'e'),
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, y, d, g) {
      ...
      } else (x = y.getConstructor(n, t, d, b)), u(x.prototype, e), (c.NEED = !0);
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, d, g) {
      ...
      var m,
        ...
        k = ('Array' == n && F.entries) || P;
      if (
        (k && (b = s(k.call(new t()))) !== Object.prototype && b.next && (f(b, w, !0), r || 'function' == typeof b[l] || u(b, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? O : S('values'), keys: d ? O : S('keys'), entries: A }), g)) for (x in m) x in F || i(F, x, m[x]);
  ...
  function(t, n, e) {
    ...
    function T(t, n, e) {
      ...
      for (
        (t = E(t)) != t || t === w
          ...
          : ((r = P(O(t) / A)),
            t * (i = F(2, -r)) < 1 && (r--, (i *= 2)),
            (t += r + f >= 1 ? s / i : s * F(2, 1 - f)) * i >= 2 && (r++, (i /= 2)),
            r + f >= a ? ((o = 0), (r = a)) : r + f >= 1 ? ((o = (t * i - 1) * F(2, n)), (r += f)) : ((o = t * F(2, f - 1) * F(2, n)), (r = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function U(t, n, e, r, o, i) {
      ...
      for (var c = t[k]._b, a = u + t[j], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var r,
      ...
      j = !!(function() {
        try {
          ...
          return (A || 'function' == typeof PromiseRejectionEvent) && t.then(k) instanceof n && 0 !== P.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && R(t), (t._h = 1)),
                        ...
                        e === n.promise ? f(_('Promise-chain cycle')) : (i = T(e)) ? i.call(e, a, f) : a(e))
                      : f(r);
                  } catch (t) {
                    s && !u && s.exit(), f(t);
                  }
    ...
    var o = e(1),
      ...
      H =
        ...
        s(function() {
          ...
          ? function(t, n, e) {
              var r = j(V, n);
              r && delete V[n], T(t, n, e), r && t !== V && T(V, n, r);
            }
          : T,
      $ = function(t) {
        var n = (G[t] = F(N.prototype));
        return (n._k = t), n;
      },
      J =
      ...
      K = function(t, n, e) {
        return (
          ...
          (n = _(n, !0)),
          x(e),
          i(G, n) ? (e.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (e = F(e, { enumerable: E(0, !1) }))) : (i(t, D) || T(t, D, E(1, {})), (t[D][n] = !0)), H(t, n, e)) : T(t, n, e)
        );
      },
      X = function(t, n) {
        x(t);
      ...
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== V || !i(G, n) || i(U, n))) {
          var e = j(t, n);
          return !e || !i(G, n) || (i(t, D) && t[D][n]) || (e.enumerable = !0), e;
        }
      },
      tt = function(t) {
        for (var n, e = I(w(t)), r = [], o = 0; e.length > o; ) i(G, (n = e[o++])) || n == D || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
        for (var n, e = t === V, r = I(e ? U : w(t)), o = [], u = 0; r.length > u; ) !i(G, (n = r[u++])) || (e && !i(V, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (a(
        (N = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === V && n.call(U, e), i(this, D) && i(this[D], t) && (this[D][t] = !1), H(this, t, E(1, e));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, S = '', w = 0, _ = 0; _ < m.length; _++) {
            x = m[_];
            for (var E = String(x[0]), F = f(s(u(x.index), p.length), 0), P = [], O = 1; O < x.length; O++) P.push(void 0 === (b = x[O]) ? b : String(b));
            var A = x.groups;
            if (h) {
              var k = [E].concat(P, F, p);
              void 0 !== A && k.push(A);
              var M = String(n.apply(void 0, k));
            } else M = y(E, p, F, P, A, n);
            F >= w && ((S += p.slice(w, F) + M), (w = F + E.length));
          }
          return S + p.slice(w);
        },
      ];
          ...
          function(t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < p.length; ) {
              ...
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : S)), p.length)) === b) S = u(p, S, d);
                ...
                for (var F = 1; F <= E.length - 1; F++) if ((w.push(E[F]), w.length === x)) return w;
                S = b = _;
              }
            }
  ...
  function(t, n, e) {
    ...
    var r,
      ...
      x = (t.exports = e(58)('WeakMap', g, m, f, !0, !0));
    p &&
      h &&
  ...
  function(t, n, e) {
    for (
      ...
      var d,
        ...
        x = u[g],
        b = x && x.prototype;
      if (b && (b[s] || c(b, s, p), b[l] || c(b, l, g), (a[g] = p), m)) for (d in r) b[d] || i(b, d, r[d], !0);
    }
  },
  function(t, n, e) {
    (function(t) {
      ...
      var e = (function(t) {
        ...
        function s(t, n, e, r) {
          var i = n && n.prototype instanceof h ? n : h,
            ...
            c = new P(r || []);
          return o(u, '_invoke', { value: w(t, e, c) }), u;
        }
        function l(t, n, e) {
          try {
        ...
        var g = Object.getPrototypeOf,
          m = g && g(g(O([])));
        m && m !== e && r.call(m, u) && (d = m);
        var x = (y.prototype = h.prototype = Object.create(d));
        function b(t) {
        ...
        function _(t, n) {
          ...
          if (void 0 === r)
            return (
              (n.delegate = null),
              ('throw' === e && t.iterator.return && ((n.method = 'return'), (n.arg = void 0), _(t, n), 'throw' === n.method)) ||
          ...
          return i
            ? i.done
              ? ((n[t.resultName] = i.value), (n.next = t.nextLoc), 'return' !== n.method && ((n.method = 'next'), (n.arg = void 0)), (n.delegate = null), p)
              : i
        ...
        return (
          ...
          (v.displayName = f(y, a, 'GeneratorFunction')),
          (t.isGeneratorFunction = function(t) {
            var n = 'function' == typeof t && t.constructor;
            return !!n && (n === v || 'GeneratorFunction' === (n.displayName || n.name));
          }),
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : ((t.__proto__ = y), f(t, a, 'GeneratorFunction')), (t.prototype = Object.create(x)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
    ...
    function o() {
      ...
      function l(t, n, e, r) {
        var o = n && n.prototype instanceof v ? n : v,
          ...
          c = new O(r || []);
        return i(u, '_invoke', { value: _(t, e, c) }), u;
      }
      function p(t, n, e) {
        try {
          return { type: 'normal', arg: t.call(n, e) };
              ...
              return new n(function(o, c) {
                !(function o(i, u, c, a) {
                  ...
                  if ('throw' !== f.type) {
                    var s = f.arg,
                      l = s.value;
                    return l && 'object' == r(l) && e.call(l, '__await')
      ...
      function E(t, n) {
        ...
        if (void 0 === r)
          return (
            (n.delegate = null),
            ('throw' === e && t.iterator.return && ((n.method = 'return'), (n.arg = void 0), E(t, n), 'throw' === n.method)) ||
              ('return' !== e && ((n.method = 'throw'), (n.arg = new TypeError("The iterator does not provide a '" + e + "' method")))),
            h
          );
        ...
        return i
          ? i.done
            ? ((n[t.resultName] = i.value), (n.next = t.nextLoc), 'return' !== n.method && ((n.method = 'next'), (n.arg = void 0)), (n.delegate = null), h)
            : i
      ...
      return (
        ...
        (O.prototype = {
          ...
          delegateYield: function(t, n, e) {
            return (this.delegate = { iterator: A(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = void 0), h;
          },
        }),
        t
      );
      ...
      t.runInteractiveFormsTest = function() {
        ...
        var e = (function() {
                ...
                return o().wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        return (i = t.sent), (t.next = 5), n.ElementWriter.create();
                      case 5:
                        return (u = t.sent).begin(e), (t.t0 = u), (t.next = 10), i.createTextBegin();
                      case 10:
                        (t.t1 = t.sent),
                        ...
                        break;
                      case 15:
                        return (c = 'l'), t.abrupt('break', 26);
                      case 17:
                        return (c = 'u'), t.abrupt('break', 26);
                      case 19:
                        return (c = '5'), t.abrupt('break', 26);
                      case 21:
                        return (c = 'n'), t.abrupt('break', 26);
                      case 23:
                        return (c = 'H'), t.abrupt('break', 26);
                      case 25:
                        c = '4';
                      case 26:
                        return (t.next = 28), n.Font.create(e, n.Font.StandardType1Font.e_zapf_dingbats);
                      case 28:
                        return (a = t.sent), (t.next = 31), i.createTextRun(c, a, 12);
                      case 31:
                        return (f = t.sent), u.writeElement(f), (t.t3 = u), (t.next = 36), i.createTextEnd();
                      case 36:
                        return (t.t4 = t.sent), t.t3.writeElement.call(t.t3, t.t4), (t.next = 40), u.end();
                      case 40:
                        return (s = t.sent), (t.next = 43), s.putRect('BBox', -0.2, -0.2, 1, 1);
                      case 43:
                        return (t.next = 45), s.putName('Subtype', 'Form');
                      case 45:
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        return (i = t.sent), (t.next = 5), n.ElementWriter.create();
                      case 5:
                        return (u = t.sent).begin(e), (t.next = 9), i.createRect(0, 0, 101, 37);
                      case 9:
                        return (c = t.sent).setPathFill(!0), c.setPathStroke(!1), (t.next = 14), c.getGState();
                      case 14:
                        return (a = t.sent), (t.t0 = a), (t.next = 18), n.ColorSpace.createDeviceGray();
                      case 18:
                        return (t.t1 = t.sent), t.t0.setFillColorSpace.call(t.t0, t.t1), (t.t2 = a), (t.next = 23), n.ColorPt.init(0.75);
                      case 23:
                        return (t.t3 = t.sent), t.t2.setFillColorWithColorPt.call(t.t2, t.t3), u.writeElement(c), (t.t4 = u), (t.next = 29), i.createTextBegin();
                      case 29:
                        return (t.t5 = t.sent), t.t4.writeElement.call(t.t4, t.t5), (f = 'Submit'), (t.next = 34), n.Font.create(e, n.Font.StandardType1Font.e_helvetica_bold);
                      case 34:
                        return (s = t.sent), (t.next = 37), i.createTextRun(f, s, 12);
                      case 37:
                        return (c = t.sent), (t.next = 40), c.getGState();
                      case 40:
                        return (a = t.sent), (t.t6 = a), (t.next = 44), n.ColorPt.init(0);
                      case 44:
                        return (
                          (t.t7 = t.sent),
                          t.t6.setFillColorWithColorPt.call(t.t6, t.t7),
                          r ? c.setTextMatrixEntries(1, 0, 0, 1, 33, 10) : c.setTextMatrixEntries(1, 0, 0, 1, 30, 13),
                          u.writeElement(c),
                          (t.t8 = u),
                          (t.next = 51),
                          i.createTextEnd()
                      ...
                      case 51:
                        return (t.t9 = t.sent), t.t8.writeElement.call(t.t8, t.t9), (t.next = 55), u.end();
                      case 55:
                        return (l = t.sent), (t.next = 58), l.putRect('BBox', 0, 0, 101, 37);
                      case 58:
                        return (t.next = 60), l.putName('Subtype', 'Form');
                      case 60:
          ...
          c = (function() {
            var t = u(
              o().mark(function t() {
                var u, c, a, f, s, l, p, h, v, y, d, g, m, x, b, S, w, _, E, F, P, O, A, k, M, j, T, I, N, L, R, D, C, B, W, G, U, V;
                return o().wrap(
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (u = null), (t.prev = 1), console.log('Beginning Test 1'), '../TestFiles/', (t.next = 6), n.PDFDoc.create();
                        case 6:
                          return (c = t.sent).initSecurityHandler(), c.lock(), console.log('PDF document initialized and locked'), (t.next = 12), c.pageCreate();
                        case 12:
                          return (a = t.sent), (t.next = 15), c.fieldCreateFromStrings('employee.name.first', n.Field.Type.e_text, 'John', '');
                        case 15:
                          return (f = t.sent), (t.next = 18), c.fieldCreateFromStrings('employee.name.last', n.Field.Type.e_text, 'Doe', '');
                        case 18:
                          return (s = t.sent), (t.next = 21), c.fieldCreateFromStrings('employee.name.check1', n.Field.Type.e_check, 'Yes', '');
                        case 21:
                          return (l = t.sent), (t.next = 24), c.fieldCreate('submit', n.Field.Type.e_button);
                        case 24:
                          return (p = t.sent), (t.t0 = n.WidgetAnnot), (t.t1 = c), (t.next = 29), n.Rect.init(50, 550, 350, 600);
                        case 29:
                          return (t.t2 = t.sent), (t.t3 = f), (t.next = 33), t.t0.create.call(t.t0, t.t1, t.t2, t.t3);
                        case 33:
                          return (h = t.sent), (t.t4 = n.WidgetAnnot), (t.t5 = c), (t.next = 38), n.Rect.init(50, 450, 350, 500);
                        case 38:
                          return (t.t6 = t.sent), (t.t7 = s), (t.next = 42), t.t4.create.call(t.t4, t.t5, t.t6, t.t7);
                        case 42:
                          return (v = t.sent), (t.t8 = n.WidgetAnnot), (t.t9 = c), (t.next = 47), n.Rect.init(64, 356, 120, 410);
                        case 47:
                          return (t.t10 = t.sent), (t.t11 = l), (t.next = 51), t.t8.create.call(t.t8, t.t9, t.t10, t.t11);
                        case 51:
                          return (y = t.sent), (t.next = 54), r(c, n.CheckStyle.e_check);
                        case 54:
                          return (d = t.sent), y.setAppearance(d, n.Annot.State.e_normal, 'Yes'), (t.t12 = n.WidgetAnnot), (t.t13 = c), (t.next = 60), n.Rect.init(64, 284, 163, 320);
                        case 60:
                          return (t.t14 = t.sent), (t.t15 = p), (t.next = 64), t.t12.create.call(t.t12, t.t13, t.t14, t.t15);
                        case 64:
                          return (g = t.sent), (t.next = 67), i(c, !1);
                        case 67:
                          return (m = t.sent), (t.next = 70), i(c, !0);
                        case 70:
                          return (x = t.sent), (t.next = 73), g.setAppearance(m, n.Annot.State.e_normal);
                        case 73:
                          return (t.next = 75), g.setAppearance(x, n.Annot.State.e_down);
                        case 75:
                          return (t.next = 77), n.FileSpec.createURL(c, 'http://www.pdftron.com');
                        case 77:
                          return (b = t.sent), (t.next = 80), n.Action.createSubmitForm(b);
                        case 80:
                          return (S = t.sent), (t.next = 83), g.getSDFObj();
                        case 83:
                          return (t.next = 85), t.sent.putDict('AA');
                        case 85:
                          return (w = t.sent), (t.t16 = w), (t.next = 89), S.getSDFObj();
                        case 89:
                          return (
                            (t.t17 = t.sent),
                            ...
                            a.annotPushBack(g),
                            c.pagePushBack(a),
                            c.refreshFieldAppearances(),
                            (t.next = 99),
                            c.saveMemoryBuffer(0)
                          );
                        case 99:
                          (u = t.sent), saveBufferAsPDFDoc(u, 'forms_test1.pdf'), console.log('Example 1 complete and everything deallocated.'), (t.next = 107);
                          break;
                        case 104:
                          (t.prev = 104), (t.t18 = t.catch(1)), console.log(t.t18.stack);
                        case 107:
                          return (t.prev = 107), console.log('Beginning Test 2'), (_ = new Uint8Array(u.buffer.slice(0))), (t.next = 112), n.PDFDoc.createFromBuffer(_);
                        case 112:
                          return (E = t.sent).initSecurityHandler(), E.lock(), console.log('Sample 2 PDF document initialized and locked'), (t.next = 118), E.getFieldIteratorBegin();
                        case 118:
                          F = t.sent;
                        case 119:
                        ...
                        case 124:
                          return (P = t.sent), (t.t19 = console), (t.next = 128), P.getName();
                        case 128:
                          return (t.t20 = t.sent), (t.t21 = 'Field name: ' + t.t20), t.t19.log.call(t.t19, t.t21), (t.t22 = console), (t.next = 134), P.getPartialName();
                        case 134:
                          return (t.t23 = t.sent), (t.t24 = 'Field partial name: ' + t.t23), t.t22.log.call(t.t22, t.t24), console.log('Field type: '), (t.next = 140), P.getType();
                        case 140:
                          return (O = t.sent), (t.next = 143), P.getValueAsString();
                        case 143:
                          (A = t.sent),
                            (t.t25 = O),
                            (t.next =
                        ...
                        case 149:
                          return console.log('Radio button: Value = ' + A), t.abrupt('break', 167);
                        case 151:
                          return (t.next = 153), F.current();
                        case 153:
                          return t.sent.setValueAsBool(!0), console.log('Check box: Value = ' + A), t.abrupt('break', 167);
                        case 157:
                          return console.log('Text'), (t.next = 160), F.current();
                        case 160:
                          return t.sent.setValueAsString('This is a new value. The old one was: ' + A), t.abrupt('break', 167);
                        case 163:
                        ...
                        case 168:
                          ...
                          break;
                        case 171:
                          return (t.next = 173), E.getField('employee.name.first');
                        case 173:
                          if (!(k = t.sent)) {
                            t.next = 184;
                            break;
                          }
                          return (t.t26 = console), (t.next = 178), k.getName();
                        case 178:
                        ...
                        case 185:
                          return E.refreshFieldAppearances(), (t.next = 188), E.saveMemoryBuffer(0);
                        case 188:
                        ...
                        case 196:
                          return (t.prev = 196), (j = new Uint8Array(u.buffer.slice(0))), (t.next = 200), n.PDFDoc.createFromBuffer(j);
                        case 200:
                          return (T = t.sent).initSecurityHandler(), T.lock(), console.log('Sample 3 PDF document initialized and locked'), (t.next = 206), T.getPage(1);
                        case 206:
                          return (I = t.sent), T.pagePushBack(I), T.pagePushBack(I), T.pagePushBack(I), T.pagePushBack(I), (t.next = 213), e(T, 'employee.name.first');
                        case 213:
                          return (t.next = 215), e(T, 'employee.name.last');
                        case 215:
                          return (t.next = 217), e(T, 'employee.name.check1');
                        case 217:
                          return (t.next = 219), e(T, 'submit');
                        case 219:
                          return (t.next = 221), T.saveMemoryBuffer(0);
                        case 221:
                          (N = t.sent), saveBufferAsPDFDoc(N, 'forms_test1_cloned.pdf'), console.log('Example 3 complete and everything deallocated.'), (t.next = 229);
                          break;
                        case 226:
                          (t.prev = 226), (t.t31 = t.catch(196)), console.log(t.t31);
                        case 229:
                          return (t.prev = 229), (L = new Uint8Array(u.buffer.slice(0))), (t.next = 233), n.PDFDoc.createFromBuffer(L);
                        case 233:
                        ...
                        case 243:
                          D = t.sent;
                        case 244:
                          return (t.next = 246), D.hasNext();
                        case 246:
                          if (!t.sent) {
                            t.next = 289;
                            break;
                          }
                          return (t.next = 249), D.current();
                        case 249:
                          return (C = t.sent), (t.next = 252), C.getAnnots();
                        case 252:
                          if (!(B = t.sent)) {
                            t.next = 285;
                            break;
                          }
                          return (t.t32 = parseInt), (t.next = 257), B.size();
                        case 257:
                          (t.t33 = t.sent), (t.t34 = (0, t.t32)(t.t33, 10)), (W = t.t34 - 1);
                        case 260:
                          if (!(W >= 0)) {
                            t.next = 285;
                            break;
                          }
                          return (t.next = 263), B.getAt(W);
                        case 263:
                          return (G = t.sent), (t.next = 266), G.get('Subtype');
                        case 266:
                          return (U = t.sent), (t.next = 269), U.value();
                        case 269:
                          return t.sent, (t.next = 272), G.get('Subtype');
                        case 272:
                        ...
                        case 276:
                          ...
                          return (t.next = 280), n.Field.create(G);
                        case 280:
                          t.sent.flatten(C);
                        case 282:
                          --W, (t.next = 260);
