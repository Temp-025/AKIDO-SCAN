...
{
    public class KYCValidationResponseDTO
    {
    ...
    public class IdValidationCallStackDTO
    {
    ...
    {
        public List<KYCValidationResponseDTO> Reports { get; set; }
        public OrgKycSummaryDTO OrgData { get; set; }

        public int TotalCount { get; set; }
    }

    public class KYCDevicesResponseDTO
    {
