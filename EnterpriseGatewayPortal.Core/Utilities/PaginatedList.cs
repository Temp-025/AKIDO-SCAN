...
namespace EnterpriseGatewayPortal.Core.Utilities
{
    public class PaginatedList<T> : List<T>
    {
        ...
        public static PaginatedList<T> Create(IEnumerable<T> source, int pageIndex, int pageSize, int totalPages, int totalCount)
        {
            return new PaginatedList<T>(source.ToList(), pageIndex, pageSize, totalPages, totalCount);
        }
    }
