!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      bt || ((U.f = Vt), (V.f = Ut)),
        c(c.S + c.F * !bt, 'Object', { getOwnPropertyDescriptor: Vt, defineProperty: Ut }),
        u(function() {
          ht.call({});
        }) &&
          (ht = vt = function() {
      ...
      v(Bt, Dt),
        h(Bt, yt, Dt.values),
        v(Bt, { slice: kt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: Lt }),
        It(Bt, 'buffer', 'b'),
        It(Bt, 'byteOffset', 'o'),
        It(Bt, 'byteLength', 'l'),
        It(Bt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? At(v, r) : jt.call(v, r);
                  (i = r), (p = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), H(t, n, r)) : N(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      nt = function(t) {
        for (var n, r = t === G, e = T(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(G, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), H(this, t, E(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), p.length), 0), P = [], M = 1; M < b.length; M++) P.push(void 0 === (x = b[M]) ? x : String(x));
            var F = b.groups;
            if (h) {
              var A = [E].concat(P, O, p);
              void 0 !== F && A.push(F);
              var I = String(n.apply(void 0, A));
            } else I = y(E, p, O, P, F, n);
            O >= w && ((S += p.slice(w, O) + I), (w = O + E.length));
          }
          return S + p.slice(w);
        },
      ];
  ...
  function(t, n) {
    ...
    window,
      (o = function(t) {
        var n = instance.Core.documentViewer.getDisplayModeManager().getDisplayMode(),
          r = (function(t) {
            var n = instance.Core.documentViewer.getScrollViewElement(),
              r = n.scrollLeft || 0,
              e = n.scrollTop || 0;
            return { x: t.pageX + r, y: t.pageY + e };
          })(t),
          e = n.getSelectedPages(r, r),
          o = null !== e.first ? e.first : instance.Core.documentViewer.getCurrentPage();
        return { point: n.windowToPage(r, o), pageNumber: o };
      }),
      (e = {
        tab: {
        ...
        panel: {
          ...
          render: function() {
            var t = instance.Core.documentViewer.SnapMode,
              n = t.DEFAULT,
              e = t.POINT_ON_LINE,
              o = t.LINE_MID_POINT,
              i = t.LINE_INTERSECTION,
              u = t.PATH_ENDPOINT,
              c = document.createElement('div'),
              f = { Default: n, 'Point On Line': e, 'Line Midpoint': o, 'Line Intersection': i, 'Path Endpoint': u };
            return (
              Object.keys(f).forEach(function(t) {
                var n = document.createElement('div');
                n.style.margin = '0px 0px 12px 12px';
                ...
                (o.innerHTML = t), (o.for = t), n.appendChild(e), n.appendChild(o), c.appendChild(n);
              }),
              (c.querySelector('input[id="Default"]').checked = !0),
              c
            );
          },
        },
      }),
      instance.UI.setCustomPanel(e),
      instance.UI.openElements([e.panel.dataElement]),
      instance.Core.documentViewer.addEventListener('pageComplete', function() {
        var t = new Annotations.LineAnnotation();
        t.setStartPoint(0, 0), t.setEndPoint(0, 0), (t.PageNumber = 1);
        var n,
          e = instance.Core.documentViewer.getAnnotationManager();
        e.addAnnotation(t);
        var i = !0;
        document.onmousemove = function() {
          clearTimeout(n),
            (n = setTimeout(function() {
              i &&
                instance.Core.documentViewer.addEventListener('mouseMove', function(n) {
                  var i = o(n),
                    u = i.point,
                    c = i.pageNumber,
                    f = t.PageNumber;
