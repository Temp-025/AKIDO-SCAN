!(function(t) {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || T(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : T(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === G && i(V, t) && !i(U, t)) && (!(n || !i(this, t) || !i(V, t) || (i(this, D) && this[D][t])) || n);
      },
      Q = function(t, n) {
      ...
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(U, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), $(this, t, E(1, r));
            };
  ...
  function(t, n) {
    var r,
      e = [
        { initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/demo-annotated.pdf', domElement: 'leftPanel' },
        { initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/report.docx', domElement: 'rightPanel' },
      ];
    Core.setWorkerPath('../../../lib/core'),
      Core.getDefaultBackendType().then(function(t) {
        (r = Core.initPDFWorkerTransports(t, {})), o(e[0]), o(e[1]);
      });
    var o = function(t) {
      WebViewer({ path: '../../../lib', workerTransportPromise: { pdf: r }, useDownloader: !1, loadAsPDF: !0, initialDoc: t.initialDoc }, document.getElementById(''.concat(t.domElement))).then(
        function(n) {
          var r = n.Core.documentViewer,
            e = n.UI,
            o = e.enableFeatures,
            i = e.enableElements,
            u = e.openElements,
            c = e.selectThumbnailPages,
            f = e.loadDocument;
          o(['ThumbnailMultiselect', 'MultipleViewerMerging']),
            i(['documentControl']),
            r.addEventListener('documentLoaded', function() {
              u(['thumbnailsPanel']), c([1]);
            }),
            document.getElementById(''.concat(t.domElement)).addEventListener('documentMerged', function(t) {
              console.log('From: '.concat(t.detail.filename, ' pages: ').concat(t.detail.pages));
            }),
            ...
            (document.getElementById(''.concat(t.domElement, '-url-form')).onsubmit = function(n) {
              n.preventDefault(), f(document.getElementById(''.concat(t.domElement, '-url')).value);
            });
        }
      );
    };
