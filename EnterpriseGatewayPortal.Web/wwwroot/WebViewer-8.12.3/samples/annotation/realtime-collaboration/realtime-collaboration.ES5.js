!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return xt in r ? At(v, r) : Mt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                ...
                for (p(t, '_d', { b: i, o: h, l: u, e: c, v: new X(i) }); s < c; ) E(t, s++);
              })),
              (_ = v.prototype = O(Bt)),
              p(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        I = P || w(y),
        F = y ? (_ ? w('entries') : I) : void 0,
        A = ('Array' == n && O.entries) || P;
      if (
        (A && (x = s(A.call(new t()))) !== Object.prototype && x.next && (f(x, S, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? I : w('values'), keys: d ? I : w('keys'), entries: F }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function B(t, n, r, e, o, i) {
      ...
      for (var c = t[A]._b, a = u + t[M], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
  ...
  function(t, n, r) {
    ...
    M ||
      ((I = function(t) {
        v(this, I, 'Promise', '_h'), p(t), e.call(this);
        try {
    ...
    var o = r(1),
      ...
      H = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || L(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : L(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== V || !i(U, n) || i(B, n))) {
          var r = M(t, n);
          return !r || !i(U, n) || (i(t, C) && t[C][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = N(S(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = N(r ? B : S(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(V, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, w = '', S = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), h.length), 0), P = [], I = 1; I < b.length; I++) P.push(void 0 === (x = b[I]) ? x : String(x));
            var F = b.groups;
            if (p) {
              var A = [E].concat(P, O, h);
              void 0 !== F && A.push(F);
              var j = String(n.apply(void 0, A));
            } else j = y(E, h, O, P, F, n);
        ...
        return (
          ...
          (P.prototype = {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: I(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), h;
            },
          }),
          t
        );
  ...
  function(t, n) {
    ...
    function e() {
      ...
      return (
        ...
        (I.prototype = {
          ...
          delegateYield: function(t, n, r) {
            return (this.delegate = { iterator: F(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), p;
          },
        }),
        t
      );
    ...
    var u = {
      ...
      c = new Server(),
      a = 'https://pdftron.s3.amazonaws.com/downloads/pl/demo-annotated.pdf';
    WebViewer({ path: '../../../lib', webviewerServerURL: 'https://demo.pdftron.com/', initialDoc: a, documentId: u[a] }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
      var n = t.Core,
        r = n.documentViewer,
        o = n.annotationManager,
        a = null,
        f = document.getElementById('url'),
        s = document.getElementById('copy');
      t.UI.openElements(['notesPanel']);
      var l = !1;
      if ('http://localhost:3000' === window.location.origin) {
        var h = new XMLHttpRequest();
        (h.onreadystatechange = function() {
          4 === h.readyState && 200 === h.status && (f.value = 'http://'.concat(h.responseText, ':3000/samples/annotation/realtime-collaboration/'));
        }),
          h.open('GET', '/ip', !0),
          h.send();
      } else (f.value = 'https://pdftron.com/samples/web/samples/annotation/realtime-collaboration/'), (f.value = 'https://pdfjs.express/samples/annotation/realtime-collaboration/');
      (s.onclick = function() {
        f.select(), document.execCommand('copy'), document.getSelection().empty();
      }),
        r.addEventListener('documentLoaded', function() {
          ...
          var n = (function() {
                  ...
                  return e().wrap(function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (t.next = 2), o.importAnnotationCommand(n.val().xfdf);
                        case 2:
                          if (((r = t.sent), !(i = r[0]))) {
                            t.next = 9;
                            break;
                          }
                          return (t.next = 7), i.resourcesLoaded();
                        case 7:
                          (i.authorId = n.val().authorId), o.redrawAnnotation(i);
                        case 9:
                        case 'end':
                          return t.stop();
                      }
            ...
            f = function(t) {
              ...
              o.importAnnotationCommand(n);
            },
            s = function(t) {
              l || (o.setCurrentUser(t), window.alert('Welcome back '.concat(t)), (l = !0));
            },
            h = function() {
              var t,
                n = window.prompt('Welcome! Tell us your name :)');
              n && ((t = n), o.setCurrentUser(t), c.updateAuthor(a, { authorName: t }));
            };
          c.bind('onAuthStateChanged', function(t) {
            t ? ((a = t.uid), c.checkAuthor(a, s, h), c.bind('onAnnotationCreated', n), c.bind('onAnnotationUpdated', u), c.bind('onAnnotationDeleted', f)) : c.signInAnonymously();
          });
        }),
        o.addEventListener(
          'annotationChanged',
                ...
                return e().wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        return (t.next = 4), o.exportAnnotationCommand();
                      case 4:
                        (u = t.sent),
                          n.forEach(function(t) {
                            var n = null;
                            'add' === r
                              ? (t.InReplyTo && (n = o.getAnnotationById(t.InReplyTo).authorId || 'default'),
                                a && (t.authorId = a),
                                c.createAnnotation(t.Id, { authorId: a, parentAuthorId: n, xfdf: u }))
                              : 'modify' === r
                              ? (t.InReplyTo && (n = o.getAnnotationById(t.InReplyTo).authorId || 'default'), c.updateAnnotation(t.Id, { authorId: a, parentAuthorId: n, xfdf: u }))
                              : 'delete' === r && c.deleteAnnotation(t.Id);
                          });
                      case 6:
                      case 'end':
                        return t.stop();
        ...
        o.setPermissionCheckCallback(function(t, n) {
          return n.authorId === a;
        }),
        (document.getElementById('select').onchange = function(n) {
          var r = u[n.target.value];
          t.UI.loadDocument(n.target.value, { documentId: r });
        });
    });
  },
]);
