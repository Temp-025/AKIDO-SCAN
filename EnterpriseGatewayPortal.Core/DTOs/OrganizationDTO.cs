...
namespace EnterpriseGatewayPortal.Core.DTOs
{
    public class OrganizationDTO
    {
        ...
        public virtual ICollection<OrgEmailDomain> OrgEmailDomains { get; } = new List<OrgEmailDomain>();

        public virtual ICollection<OrgSignatureTemplate> OrgSignatureTemplates { get; } = new List<OrgSignatureTemplate>();

        public virtual ICollection<OrgSubscriberEmail> OrgSubscriberEmails { get; } = new List<OrgSubscriberEmail>();

        public virtual ICollection<OrganizationCertificate> OrganizationCertificates { get; } = new List<OrganizationCertificate>();
    }
}
