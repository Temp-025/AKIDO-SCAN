!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), b = o(g), m = e(c, v, 3), S = u(b.length), x = 0, w = r ? h(n, S) : f ? h(n, 0) : void 0; S > x; x++)
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        kt = function(t, n) {
          return jt(this, pt.call(Pt(this), t, n));
        },
        Ct = function(t) {
          Pt(this);
        ...
        Ut = function(t, n) {
          return Wt(t, (n = m(n, !0))) ? p(2, t[n]) : V(t, n);
        },
        Bt = function(t, n, r) {
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (p = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                ...
                for (h(t, '_d', { b: i, o: p, l: u, e: c, v: new K(i) }); s < c; ) O(t, s++);
              })),
              (_ = v.prototype = E(Gt)),
              h(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, p) {
      ...
      if (i(g)) {
        for (h = c(t.length); h > m; m++) if ((d = n ? b(u((v = t[m]))[0], v[1]) : b(t[m])) === a || d === s) return d;
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var b,
        ...
        F = P || x(y),
        j = y ? (_ ? x('entries') : F) : void 0,
        M = ('Array' == n && E.entries) || P;
      if (
        (M && (S = s(M.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((O = !0),
        ...
        if (((b = { values: _ ? F : x('values'), keys: d ? F : x('keys'), entries: j }), g)) for (m in b) m in E || i(E, m, b[m]);
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (j || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== P.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
      ...
      R = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                j ? O.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = j || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(f, function() {
          var n;
          j ? O.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      C = function(t) {
        var n = this;
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = E(r, { enumerable: O(0, !1) }))) : (i(t, C) || T(t, C, O(1, {})), (t[C][n] = !0)), X(t, n, r)) : T(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
      ...
      (f(
        (R = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), X(this, t, O(1, r));
            };
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            b = s(p);
          if ((d && (y = e(y, v > 2 ? arguments[2] : void 0, 2)), null == b || (h == Array && c(b)))) for (r = new h((n = f(p.length))); n > g; g++) a(r, g, d ? y(p[g], g) : p[g]);
          else for (l = b.call(p), r = new h(); !(o = l.next()).done; g++) a(r, g, d ? u(l, y, [o.value, g], !0) : o.value);
          return (r.length = g), r;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var O = String(m[0]), E = a(s(u(m.index), p.length), 0), P = [], F = 1; F < m.length; F++) P.push(void 0 === (S = m[F]) ? S : String(S));
            var j = m.groups;
            if (h) {
              var M = [O].concat(P, E, p);
              void 0 !== j && M.push(j);
              var A = String(n.apply(void 0, M));
            } else A = y(O, p, E, P, j, n);
            E >= w && ((x += p.slice(w, E) + A), (w = E + O.length));
          }
          return x + p.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < p.length; ) {
              ...
              var _,
                O = f(b, v ? p : p.slice(x));
              if (null === O || (_ = l(c(b.lastIndex + (v ? 0 : x)), p.length)) === S) x = u(p, x, d);
              else {
                if ((w.push(p.slice(S, x)), w.length === m)) return w;
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        m = u[g],
        S = m && m.prototype;
      if (S && (S[s] || c(S, s, p), S[l] || c(S, l, g), (f[g] = p), b)) for (d in e) S[d] || i(S, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
      ...
      var r = (function(t) {
        ...
        var g = Object.getPrototypeOf,
          b = g && g(g(F([])));
        b && b !== r && e.call(b, u) && (d = b);
        var m = (y.prototype = h.prototype = Object.create(d));
        function S(t) {
        ...
        return (
          ...
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : ((t.__proto__ = y), a(t, f, 'GeneratorFunction')), (t.prototype = Object.create(m)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
    ...
    !(function(t) {
      t.TriangleAnnotationFactory = {
        initialize: function(n, r) {
          var i = (function(i) {
            ...
            function h() {
              ...
              !(function(t, n) {
                ...
                ((e = p.call(this, 'triangle')).Subject = 'Triangle'),
            ...
            return (
              ...
              (s = [
                ...
                },
                {
                  key: 'serialize',
                  value: function(t, r) {
                    var e = o(a(h.prototype), 'serialize', this).call(this, t, r);
                ...
                },
                {
                  key: 'deserialize',
                  value: function(t, r) {
                    o(a(h.prototype), 'deserialize', this).call(this, t, r), (this.vertices = n.XfdfUtils.deserializePointArray(t.getAttribute('vertices'), r));
                  },
                },
              ]) && e(f.prototype, s),
              l && e(f, l),
          ...
          return (i.SerializationType = n.CustomAnnotation.SerializationTypes.STAMP), (i.prototype.elementName = 'triangle'), i;
        },
