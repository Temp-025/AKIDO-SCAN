!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Ft = function(t, n) {
          if (!S(t) || !(gt in t)) throw Y('It is not a typed array constructor!');
          return new t(n);
        },
        jt = function(t, n) {
        ...
        Rt = function(t, n) {
          return jt(this, ht.call(Pt(this), t, n));
        },
        Dt = function(t) {
          Pt(this);
      ...
      v(Gt, Ct),
        p(Gt, yt, Ct.values),
        v(Gt, { slice: Rt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: kt }),
        It(Gt, 'buffer', 'b'),
        It(Gt, 'byteOffset', 'o'),
        It(Gt, 'byteLength', 'l'),
        It(Gt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return xt in r ? Mt(v, r) : At.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, f),
                  S(r)
                    ? r instanceof H || 'ArrayBuffer' == (i = w(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new y(r, Ot(e, n), o)
                        : void 0 !== e
                        ? new y(r, Ot(e, n))
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        F = P || w(y),
        j = y ? (_ ? w('entries') : F) : void 0,
        M = ('Array' == n && O.entries) || P;
      if (
        (M && (x = s(M.call(new t()))) !== Object.prototype && x.next && (f(x, S, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? F : w('values'), keys: d ? F : w('keys'), entries: j }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function G(t, n, r, e, o, i) {
      ...
      for (var c = t[M]._b, a = u + t[A], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var e,
      ...
      A = !!(function() {
        try {
          ...
          return (j || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== P.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      L = function(t) {
        var n;
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && R(t), (t._h = 1)),
                        ...
                        r === n.promise ? f(_('Promise-chain cycle')) : (i = L(r)) ? i.call(r, a, f) : a(r))
                      : f(e);
                  } catch (t) {
                    s && !u && s.exit(), f(t);
                  }
      ...
      k = function(t) {
        g.call(a, function() {
          ...
          if (
            (i &&
              ((n = x(function() {
                j ? E.emit('unhandledRejection', o, t) : (r = a.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = a.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = j || T(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      R = function(t) {
        g.call(a, function() {
          var n;
          j ? E.emit('rejectionHandled', t) : (n = a.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      D = function(t) {
        var n = this;
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      q =
        ...
        s(function() {
          ...
          ? function(t, n, r) {
              var e = A(V, n);
              e && delete V[n], L(t, n, r), e && t !== V && L(V, n, e);
            }
          : L,
      H = function(t) {
        var n = (U[t] = O(k.prototype));
        return (n._k = t), n;
      },
      K =
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || L(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : L(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
        for (var r, e = g((n = S(n))), o = 0, i = e.length; i > o; ) J(t, (r = e[o++]), n[r]);
        return t;
      },
      Z = function(t) {
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      k.prototype[C] || r(14)(k.prototype, C, k.prototype.valueOf),
      h(k, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
  ...
  function(t, n) {
    ...
    function e() {
      ...
      return (
        ...
        (F.prototype = {
          ...
          delegateYield: function(t, n, r) {
            return (this.delegate = { iterator: j(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), p;
          },
        }),
        t
      );
    ...
    ((a = c(
      e().mark(function t(n) {
        var r, i, u, a, f, s, l, h, p, v, y, d, g, m, b, x, w, S, _, E;
        return e().wrap(function(t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                return (r = n.Core), (i = n.Core.PDFNet), r.setWorkerPath('../../../lib/core'), r.enableFullPDF(), (t.next = 6), i.initialize();
              case 6:
                (u = window.parent.window.document),
                  (a = r.initPDFWorkerTransports('pdf', {}, void 0)),
                  (f = ['viewer1', 'viewer2']),
                  (s = []),
                  (l = ['/samples/files/semantic_test_doc_1.pdf', '/samples/files/semantic_test_doc_2.pdf']),
                  (h = null),
                  (p = null),
                  (v = function(t) {
                    return new Promise(function(n) {
                      WebViewer({ path: '../../../lib', workerTransportPromise: a, fullAPI: !0 }, document.getElementById(t)).then(function(t) {
                        t.Core.syncNamespaces({ PDFNet: i }),
                          t.Core.documentViewer.addEventListener('documentLoaded', function() {
                            var n = t.Core.documentViewer.getScrollViewElement();
                            (n.onscroll = function() {
                              if (!p || p === n) {
                                p = n;
                                var t = n.scrollLeft / n.scrollWidth,
                                  r = n.scrollTop / n.scrollHeight;
                                g(t, r),
                                  clearTimeout(h),
                              ...
                              t.Core.documentViewer.addEventListener('zoomUpdated', function(t) {
                                p ||
                                  ((p = n),
                                  clearTimeout(h),
                                  (h = setTimeout(function() {
                              ...
                              t.Core.documentViewer.addEventListener('rotationUpdated', function(t) {
                                b(t);
                              });
                          }),
                          s.push(t),
                            ...
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (
                                  ...
                                  (r = l.map(function(t) {
                                    return i.PDFDoc.createFromURL(t);
                                  })),
                                  (t.next = 4),
                                  Promise.all([].concat(o(n), o(r)))
                                );
                              case 4:
                                return (t.next = 6), Promise.all(r);
                              case 6:
                                return (a = t.sent), (t.next = 9), x(a[0], a[1]);
                              case 9:
                                (u.getElementById('fileUpload1').disabled = !1),
                                  (u.getElementById('fileUpload2').disabled = !1),
                                  u.getElementById('compareButton').addEventListener(
                                    'click',
                                    c(
                                      e().mark(function t() {
                                        var n, r;
                                        return e().wrap(function(t) {
                                          for (;;)
                                            switch ((t.prev = t.next)) {
                                              case 0:
                                                return (n = y[0]), (r = y[1]), S(), (t.next = 5), x(n, r);
                                              case 5:
                                              case 'end':
                                                return t.stop();
                                            }
                  ...
                  (g = function(t, n) {
                    s.forEach(function(r) {
                      var e = r.docViewer.getScrollViewElement();
                      if (e) {
                        var o = e.scrollLeft / e.scrollWidth,
                          i = e.scrollTop / e.scrollHeight;
                        o !== t && (e.scrollLeft = e.scrollWidth * t), i !== n && (e.scrollTop = e.scrollHeight * n);
                      }
                    });
                  }),
                  (m = function(t) {
                    s.forEach(function(n) {
                      n.UI.getZoomLevel() !== t && n.UI.setZoomLevel(t);
                    });
                  }),
                  (b = function(t) {
                    s.forEach(function(n) {
                  ...
                  (x = (function() {
                    var t = c(
                      e().mark(function t(n, r) {
                        var o, c, a, f, l, h, p, v, g, m, b, x;
                        return e().wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), n.getPageCount();
                              case 2:
                                return (o = t.sent), (t.next = 5), r.getPageCount();
                              case 5:
                                return (c = t.sent), (t.next = 8), i.PDFDoc.create();
                              case 8:
                                return (a = t.sent).lock(), (t.next = 12), i.PDFDoc.create();
                              case 12:
                                return (f = t.sent).lock(), (t.next = 16), i.PDFDoc.create();
                              case 16:
                                return (l = t.sent).lock(), (t.next = 20), l.appendTextDiffDoc(n, r);
                              case 20:
                                return (t.next = 22), l.getPageCount();
                              case 22:
                                (h = t.sent), (p = o > c), (v = o > c ? o : c), (g = 0);
                              case 26:
                                if (!(g < h)) {
                                  t.next = 49;
                                  break;
                                }
                                return (t.next = 29), l.getPage(g + 1);
                              case 29:
                                if (((m = t.sent), g !== v)) {
                                  t.next = 39;
                                  break;
                                ...
                                return (t.next = 34), a.pagePushBack(m);
                              case 34:
                                t.next = 38;
                                break;
                              case 36:
                                return (t.next = 38), f.pagePushBack(m);
                              case 38:
                              ...
                              case 39:
                                ...
                                return (t.next = 42), a.pagePushBack(m);
                              case 42:
                                t.next = 46;
                                break;
                              case 44:
                                return (t.next = 46), f.pagePushBack(m);
                              case 46:
                                g++, (t.next = 26);
                                break;
                              case 49:
                                return (t.next = 51), l.unlock();
                              case 51:
                                return (t.next = 53), a.unlock();
                              case 53:
                                return (t.next = 55), f.unlock();
                              case 55:
                                if ((s[0].UI.loadDocument(a), s[1].UI.loadDocument(f), d.push([].concat(y)), 1 !== d.length)) {
                                  t.next = 60;
                                  break;
                                }
                                return t.abrupt('return');
                              case 60:
                                (b = u.getElementById('recentFiles')),
                                  ((x = document.createElement('button')).innerText = 'Compare '.concat(n.fileName, ' (A) & ').concat(r.fileName, ' (B)')),
                                  x.classList.add('link'),
                                  (x.onclick = E.bind({ idx: d.length - 1 })),
                                  b.appendChild(x);
                              case 66:
                              case 'end':
                                return t.stop();
                      ...
                      e().mark(function t() {
                        ...
                        return e().wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                if ((n = u.getElementById('compareButton')).classList.contains('disabled')) {
                                  t.next = 3;
                                  break;
                                }
                                return t.abrupt('return');
                      ...
                      e().mark(function t(n, o) {
                        ...
                        return e().wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), r.createDocument(n, {});
                              case 2:
                                return (i = t.sent), (t.next = 5), i.getPDFDoc();
                              case 5:
                                (y[o] = t.sent), (y[o].fileName = n.name), null !== y[1] && null !== y[0] && w();
                              case 8:
                              case 'end':
                                return t.stop();
                            }
                  ...
                  u.getElementById('fileUpload1').addEventListener('change', function(t) {
                    _(t.target.files[0], 0);
                  }),
                  u.getElementById('fileUpload2').addEventListener('change', function(t) {
                    _(t.target.files[0], 1);
                  }),
                  (E = (function() {
                    var t = c(
                      e().mark(function t() {
                        return e().wrap(
                          function(t) {
                            for (;;)
                              switch ((t.prev = t.next)) {
                                case 0:
                                  return (t.next = 2), x(d[this.idx][0], d[this.idx][1]);
                                case 2:
                                case 'end':
                                  return t.stop();
                              }
