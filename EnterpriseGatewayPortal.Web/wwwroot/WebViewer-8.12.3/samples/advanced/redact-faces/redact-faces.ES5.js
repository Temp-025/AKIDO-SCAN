          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || L(t, C, E(1, {})), (t[C][n] = !0)), K(t, n, r)) : L(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), K(this, t, E(1, r));
            };
          return u && q && K(V, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
        ...
        var e = t.Core,
          ...
          a = r.map(function(t) {
            var n = t.box.x,
              ...
              f = [n, r + o],
              s = [n + e, r + o];
            return u(c.Quad, f.concat(s, a, i));
          }),
          f = new o.RedactionAnnotation({ Quads: a });
        (f.Author = i.getCurrentUser()), (f.PageNumber = n), (f.StrokeColor = new o.Color(255, 0, 0, 1)), i.addAnnotation(f, !1), i.redrawAnnotation(f);
      }
    }
    function s(t, n) {
      return new Promise(function(r) {
        var o = t.Core.documentViewer.getDocument(),
          u = o.getPageInfo(n),
                    ...
                    return e().wrap(function(e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (e.next = 2), faceapi.detectAllFaces(i, new faceapi.SsdMobilenetv1Options({ minConfidence: 0.4, maxResults: 300 }));
                          case 2:
                            (u = e.sent), (a = faceapi.resizeResults(u, c)), f(t, n, a), r();
                          case 6:
                          case 'end':
                            return e.stop();
                        }
    ...
    faceapi.nets.ssdMobilenetv1.loadFromUri('https://pdftron.s3.amazonaws.com/downloads/pl/face-redaction-models'),
      WebViewer(
                ...
                return e().wrap(function(n) {
                  for (;;)
                    switch ((n.prev = n.next)) {
                      case 0:
                        t.UI.closeElements(['redact-faces-instructions-modal']),
                          (r = t.Core.documentViewer.getDocument()),
                          (o = r.getPageCount()),
                          (i = createProgress(o)),
                          (u = i.sendPageProcessing),
                          (c = i.showProgress),
                          (a = i.hideProgress),
                          c(),
                          (f = 1);
        ...
        t.Core.documentViewer.addEventListener('documentLoaded', function() {
          ...
          t.UI.setCustomModal(e), t.UI.openElements(['redact-faces-instructions-modal']);
        });
      });
  },
]);
