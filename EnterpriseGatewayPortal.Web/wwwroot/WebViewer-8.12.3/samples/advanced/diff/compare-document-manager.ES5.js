!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), b = e(c, v, 3), x = u(m.length), w = 0, S = r ? p(n, x) : f ? p(n, 0) : void 0; x > w; w++)
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Rt = {
          ...
          filter: function(t) {
            return jt(this, H(Pt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = w(r)) || 'SharedArrayBuffer' == f)) return xt in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (M && (x = s(M.call(new t()))) !== Object.prototype && x.next && (a(x, S, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
  ...
  function(t, n, r) {
    ...
    var e,
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && k(t), (t._h = 1)),
                        ...
                        r === n.promise ? a(_('Promise-chain cycle')) : (i = L(r)) ? i.call(r, f, a) : f(r))
                      : a(e);
                  } catch (t) {
                    s && !u && s.exit(), a(t);
                  }
      ...
      T = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = x(function() {
                j ? E.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = j || R(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(f, function() {
          var n;
          j ? E.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      C = function(t) {
        var n = this;
    ...
    var o = r(1),
      ...
      $ =
        ...
        s(function() {
          ...
          ? function(t, n, r) {
              var e = I(U, n);
              e && delete U[n], L(t, n, r), e && t !== U && L(U, n, e);
            }
          : L,
      K = function(t) {
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || L(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : L(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
        for (var r, e = g((n = S(n))), o = 0, i = e.length; i > o; ) X(t, (r = e[o++]), n[r]);
        return t;
      },
      Z = function(t) {
      ...
      tt = function(t) {
        for (var n, r = N(S(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = N(r ? B : S(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(U, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (f(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
    ...
    (function(t) {
      ...
      var r = (function(t) {
        ...
        function S(t, n, r) {
          ...
          return function(o, i) {
            ...
            for (r.method = o, r.arg = i; ; ) {
              ...
              var f = l(t, n, r);
              if ('normal' === f.type) {
                if (((e = r.done ? 'completed' : 'suspendedYield'), f.arg === h)) continue;
        ...
        return (
          ...
          (v.displayName = a(y, f, 'GeneratorFunction')),
          (t.isGeneratorFunction = function(t) {
            var n = 'function' == typeof t && t.constructor;
            return !!n && (n === v || 'GeneratorFunction' === (n.displayName || n.name));
          }),
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : ((t.__proto__ = y), a(t, f, 'GeneratorFunction')), (t.prototype = Object.create(b)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
          x(w.prototype),
          a(w.prototype, c, function() {
            return this;
          }),
          (t.AsyncIterator = w),
  ...
  function(t, n) {
    ...
    function e() {
      ...
      function _(t, n, r) {
        ...
        return function(o, i) {
          ...
          for (r.method = o, r.arg = i; ; ) {
            ...
            var f = h(t, n, r);
            if ('normal' === f.type) {
              if (((e = r.done ? 'completed' : 'suspendedYield'), f.arg === p)) continue;
              return { value: f.arg, done: r.done };
            }
            'throw' === f.type && ((e = 'completed'), (r.method = 'throw'), (r.arg = f.arg));
          }
      ...
      return (
        ...
        (y.displayName = s(d, a, 'GeneratorFunction')),
        (t.isGeneratorFunction = function(t) {
          var n = 'function' == typeof t && t.constructor;
          return !!n && (n === y || 'GeneratorFunction' === (n.displayName || n.name));
        }),
        (t.mark = function(t) {
          return Object.setPrototypeOf ? Object.setPrototypeOf(t, d) : ((t.__proto__ = d), s(t, a, 'GeneratorFunction')), (t.prototype = Object.create(x)), t;
        }),
        (t.awrap = function(t) {
          return { __await: t };
        }),
                ...
                function(r) {
                  for (;;)
                    switch ((r.prev = r.next)) {
                      case 0:
                        return (
                          (this.documentViewer = o.documentViewer),
                          (n.prototype = Object.create(o.BaseDocument.prototype)),
                          Object.assign(n.prototype, t.FunctionsToOverride),
                          Object.assign(n.prototype, t.PublicAPIsForCompareDocs),
                          o.Document.registerDocumentType('compare-docs', n, Object.keys(t.PublicAPIsForCompareDocs)),
                          (r.next = 7),
                          c.loadDocumentsToCompare(i, u)
                        );
                      case 7:
                      case 'end':
                        return r.stop();
