!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      bt || ((B.f = Gt), (G.f = Bt)),
        c(c.S + c.F * !bt, 'Object', { getOwnPropertyDescriptor: Gt, defineProperty: Bt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Ut, Dt),
        p(Ut, yt, Dt.values),
        v(Ut, { slice: Rt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Nt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (j && (x = s(j.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? M : S('values'), keys: d ? M : S('keys'), entries: F }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function U(t, n, r, e, o, i) {
      ...
      for (var c = t[j]._b, a = u + t[I], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (F || 'function' == typeof PromiseRejectionEvent) && t.then(j) instanceof n && 0 !== P.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      L = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || L(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : L(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      Q = function(t) {
        ...
        return !(this === V && i(B, t) && !i(U, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, C) && this[C][t])) || n);
      },
      Z = function(t, n) {
      ...
      nt = function(t) {
        for (var n, r = t === V, e = T(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(V, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
      ...
      (r(45).f = Q),
      (F.f = nt),
      u && !r(30) && a(V, 'propertyIsEnumerable', Q, !0),
      (y.f = function(t) {
        return H(v(t));
      })),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), h.length), 0), P = [], M = 1; M < b.length; M++) P.push(void 0 === (x = b[M]) ? x : String(x));
            var F = b.groups;
            if (p) {
      ...
      var r = (function(t) {
        ...
        function s(t, n, r, e) {
          var i = n && n.prototype instanceof p ? n : p,
            ...
            c = new P(e || []);
          return o(u, '_invoke', { value: w(t, r, c) }), u;
        }
        function l(t, n, r) {
          try {
        ...
        return (
          ...
          (P.prototype = {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: M(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), h;
            },
          }),
          t
        );
  ...
  function(t, n, r) {
    ...
    !(function(t) {
      t.runTextSearchTest = function() {
        var n = t.Core.PDFNet,
          r = (function() {
            var t,
              r =
                ((t = o().mark(function t() {
                  var r, e, i, u, c, a, f, s, l, h, p, v, y, d, g, m, b, x;
                  return o().wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (t.prev = 2), (t.next = 5), n.PDFDoc.createFromURL('../TestFiles/credit card numbers.pdf');
                          case 5:
                            return (r = t.sent).initSecurityHandler(), r.lock(), (t.next = 10), n.TextSearch.create();
                          case 10:
                            (e = t.sent), (i = n.TextSearch.Mode.e_whole_word + n.TextSearch.Mode.e_page_stop), (u = 'joHn sMiTh'), e.begin(r, u, i), (c = 0);
                          case 15:
                            return (t.next = 18), e.run();
                          case 18:
                            if (((a = t.sent), (f = void 0), a.code !== n.TextSearch.ResultCode.e_found)) {
                              t.next = 119;
                              break;
                            }
                            if (0 !== c) {
                            ...
                            return console.log(a.out_str + "'s credit card number is: "), (t.next = 25), e.getMode();
                          case 25:
                            (i = t.sent),
                              (i += n.TextSearch.Mode.e_reg_expression + n.TextSearch.Mode.e_highlight),
                              e.setMode(i),
                              (u = '\\d{4}-\\d{4}-\\d{4}-\\d{4}'),
                              e.setPattern(u),
                              ++c,
                          ...
                          case 33:
                            ...
                            console.log('  ' + a.out_str), (f = a.highlights).begin(r);
                          case 37:
                            return (t.next = 39), f.hasNext();
                          case 39:
                            if (!t.sent) {
                              t.next = 48;
                              break;
                            }
                            return (t.next = 42), f.getCurrentPageNumber();
                          case 42:
                            return (s = t.sent), console.log('The current highlight is from page: ' + s), (t.next = 46), f.next();
                          case 46:
                            t.next = 37;
                            break;
                          case 48:
                            (u = '\\d{4}-\\d{6}-\\d{5}'), e.setPattern(u), ++c, (t.next = 117);
                            break;
                          case 53:
                            if (2 !== c) {
                              t.next = 65;
                            ...
                            return console.log('\nThere is an AMEX card number:\n  ' + a.out_str), (t.next = 57), e.getMode();
                          case 57:
                            (i = t.sent), (i += n.TextSearch.Mode.e_search_up), e.setMode(i), (u = '[A-z]++ [A-z]++'), e.setPattern(u), ++c, (t.next = 117);
                            break;
                          case 65:
                            if (3 !== c) {
                              t.next = 117;
                            ...
                            return console.log("Is the owner's name:\n  " + a.out_str + '?'), (f = a.highlights), (t.next = 70), f.begin(r);
                          case 70:
                            return (t.next = 72), f.hasNext();
                          case 72:
                            if (!t.sent) {
                              t.next = 112;
                              break;
                            }
                            return (t.t0 = r), (t.next = 76), f.getCurrentPageNumber();
                          case 76:
                            return (t.t1 = t.sent), (t.next = 79), t.t0.getPage.call(t.t0, t.t1);
                          case 79:
                            return (l = t.sent), (t.next = 82), f.getCurrentQuads();
                          case 82:
                            (h = t.sent), (p = 0);
                          case 84:
                            if (!(p < h.length)) {
                            ...
                            return (
                              (v = h[p]),
                              (y = Math.min(Math.min(Math.min(v.p1x, v.p2x), v.p3x), v.p4x)),
                              (d = Math.max(Math.max(Math.max(v.p1x, v.p2x), v.p3x), v.p4x)),
                              (g = Math.min(Math.min(Math.min(v.p1y, v.p2y), v.p3y), v.p4y)),
                              (m = Math.max(Math.max(Math.max(v.p1y, v.p2y), v.p3y), v.p4y)),
                              (t.t2 = n.LinkAnnot),
                              (t.t3 = r),
                              (t.next = 94),
                              n.Rect.init(y, g, d, m)
                          ...
                          case 94:
                            return (t.t4 = t.sent), (t.next = 97), t.t2.create.call(t.t2, t.t3, t.t4);
                          case 97:
                            return (b = t.sent), (t.t5 = b), (t.next = 101), n.Action.createURI(r, 'http://www.pdftron.com');
                          case 101:
                            return (t.t6 = t.sent), (t.next = 104), t.t5.setAction.call(t.t5, t.t6);
                          case 104:
                            return (t.next = 106), l.annotPushBack(b);
                          case 106:
                            ++p, (t.next = 84);
                            break;
                          case 109:
                            ...
                            break;
                          case 112:
                            return (t.next = 114), r.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 114:
                            return (x = t.sent), saveBufferAsPDFDoc(x, 'credit card numbers_linked.pdf'), t.abrupt('break', 127);
                          case 117:
                            t.next = 125;
                            break;
                          case 119:
                            if (a.code !== n.TextSearch.ResultCode.e_page) {
                              t.next = 123;
                              break;
                            }
                            console.log('page end'), (t.next = 125);
                            break;
                          case 123:
                            if (a.code !== n.TextSearch.ResultCode.e_done) {
                              t.next = 125;
                              break;
                            }
                            return t.abrupt('break', 127);
                          case 125:
                            t.next = 15;
                            break;
                          case 127:
                            ...
                            break;
                          case 129:
                            (t.prev = 129), (t.t7 = t.catch(2)), console.log(t.t7);
                          case 132:
                          case 'end':
                            return t.stop();
                        }
