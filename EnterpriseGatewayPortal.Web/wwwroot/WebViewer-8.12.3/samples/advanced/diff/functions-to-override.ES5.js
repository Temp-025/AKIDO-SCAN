!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Ct = function() {
          return vt.apply(It ? ht.call(Ot(this)) : Ot(this), arguments);
        },
        Rt = {
          ...
          subarray: function(t, n) {
            var r = Ot(this),
              e = r.length,
              o = m(t, e);
            return new (I(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, y((void 0 === n ? e : m(n, e)) - o));
          },
        },
        Lt = function(t, n) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof Z || 'ArrayBuffer' == (c = w(r)) || 'SharedArrayBuffer' == c)) return xt in r ? Ft(v, r) : jt.call(v, r);
                  (i = r), (h = Et(e, n));
                  var g = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    function G(t, n, r, e, o, i) {
      ...
      for (var a = t[F]._b, c = u + t[j], f = e(+o), s = 0; s < n; s++) a[c + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      tt = function(t) {
        for (var n, r = I(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = I(r ? G : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(V, n)) || o.push(B[n]);
        return o;
      };
    X ||
      (c(
      ...
      var r = (function(t) {
        ...
        function s(t, n, r, e) {
          var i = n && n.prototype instanceof p ? n : p,
            ...
            a = new O(e || []);
          return o(u, '_invoke', { value: S(t, r, a) }), u;
        }
        function l(t, n, r) {
          try {
          ...
          if (null != r) {
            ...
            try {
              if (((i = (r = r.call(t)).next), 0 === n)) {
                ...
                c = !1;
              } else for (; !(c = (e = i.call(r)).done) && (a.push(e.value), a.length !== n); c = !0);
            } catch (t) {
              (f = !0), (o = t);
            } finally {
              try {
    ...
    function s() {
      ...
      function l(t, n, r, e) {
        var i = n && n.prototype instanceof v ? n : v,
          u = Object.create(i.prototype),
          a = new M(e || []);
        return o(u, '_invoke', { value: _(t, r, a) }), u;
      }
      function h(t, n, r) {
        try {
          return { type: 'normal', arg: t.call(n, r) };
      ...
      var m = Object.getPrototypeOf,
        b = m && m(m(T([])));
      b && b !== n && e.call(b, u) && (d = b);
      var x = (y.prototype = v.prototype = Object.create(d));
      function w(t) {
        ['next', 'throw', 'return'].forEach(function(n) {
          f(t, n, function(t) {
            return this._invoke(n, t);
      ...
      function _(t, n, r) {
        ...
        return function(o, i) {
          ...
          for (r.method = o, r.arg = i; ; ) {
            ...
            var c = h(t, n, r);
            if ('normal' === c.type) {
              if (((e = r.done ? 'completed' : 'suspendedYield'), c.arg === p)) continue;
              return { value: c.arg, done: r.done };
            }
            'throw' === c.type && ((e = 'completed'), (r.method = 'throw'), (r.arg = c.arg));
          }
      ...
      function P(t, n) {
        ...
        if (void 0 === e)
          return (
            (n.delegate = null),
            ('throw' === r && t.iterator.return && ((n.method = 'return'), (n.arg = void 0), P(t, n), 'throw' === n.method)) ||
              ('return' !== r && ((n.method = 'throw'), (n.arg = new TypeError("The iterator does not provide a '" + r + "' method")))),
            p
          );
      ...
      return (
        ...
        (g.displayName = f(y, c, 'GeneratorFunction')),
        (t.isGeneratorFunction = function(t) {
          var n = 'function' == typeof t && t.constructor;
          return !!n && (n === g || 'GeneratorFunction' === (n.displayName || n.name));
        }),
        (t.mark = function(t) {
          return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : ((t.__proto__ = y), f(t, c, 'GeneratorFunction')), (t.prototype = Object.create(x)), t;
        }),
        (t.awrap = function(t) {
          return { __await: t };
        }),
        ...
        (M.prototype = {
          ...
          delegateYield: function(t, n, r) {
            return (this.delegate = { iterator: T(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), p;
          },
        }),
        t
      );
